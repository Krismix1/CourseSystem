...
public class InitialDataLoader implements
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        course.setLearningContent("Students will be able to code a full stack web based application, set-up a NODEJS server in the cloud and decide the best possible use of MongoDB");
    ...
    @Transactional
    private AdministrationWorker createAdministratorIfNotFound(AdministrationWorker administrationWorker) {
    ...
    @Transactional
    private AccountRole createRoleIfNotFound(String name) {
    ...
    @Transactional
    private Account createAccountIfNotFound(Account account) {
    ...
    @Transactional
    private Course createCourseIfNotFound(Course course) {
    ...
    @Transactional
    private StudyProgramme createStudyProgrammeIfNotFound(StudyProgramme studyProgramme) {
